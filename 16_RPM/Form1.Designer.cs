namespace _16_RPM
{
	partial class Form1
	{
		...
		private void InitializeComponent()
		{
			...
			this.button1.Text = "Вывести информацию о ВУЗе";
			...
			this.textBox3.Location = new System.Drawing.Point(493, 97);
			...
			this.textBox2.Location = new System.Drawing.Point(233, 97);
			...
			this.label2.Text = "Введите год основания:";
			// 
			// textBox1
			// 
			...
			this.label1.Text = "Введите название вуза:";
			// 
			// Form1
			// 
			...
			this.Name = "Form1";
			this.Text = "Класс `ВУЗ` с полями: название, год основания, рейтинг";
